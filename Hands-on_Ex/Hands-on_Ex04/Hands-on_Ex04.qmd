...
## 1.7 Significant Test of Association (Dependence): ggbarstats() methods
...
## 2.3 Visualising the uncertainty of point errors with interactive error bars
...
## 3.2 Make over with 95% and 99% confidence interval 
...
## 4.1 Install and Load Package

```{r}
devtools::install_github("wilkelab/ungeviz")
```

## 4.2 Launch Application in R

```{r}
library(ungeviz)
```

## 4.3 Visualising Uncertainty with HOPs
