...
From this boxplot, we can see that container ship has the highest median of ship speed. The high operational cost of
...
v8 <- ggplot(data = loss, 
  ...
  facet_wrap(~ Ship_Type, scales = "free") +
  scale_y_continuous(limits = c(0, 50)) +
  theme_minimal() +
  labs(x = "Maintenance Status", 
       y = "Count", 
       title = "Maintenance Status Distribution by Ship Type") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  coord_flip()
